    ...
    <div class="login-card">
        <div class="login-header">
            <div class="brand-badge" style="background: #ffffff; padding: 4px;">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo <?php echo e($namaSekolah); ?>" style="width: 100%; height: 100%; object-fit: contain;">
            </div>
            <h2><?php echo e($namaSekolah); ?></h2>
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="login" class="form-input" placeholder="Masukkan username, email, atau NISN" value="<?php echo e(old('login')); ?>" required autofocus>
                </div>
            </div>
            ...
            <div style="text-align: center; margin-top: 16px; font-size: 13px; color: #64748b;">
                ...
                <a href="<?php echo e(route('register')); ?>" style="color: #2563eb; font-weight: 700; text-decoration: none;">Klaim Akun Siswa (NISN) ↗</a>
            </div>
        </form>
    </div>
...
<?php /**PATH D:\web skripsi\resources\views/auth/login.blade.php ENDPATH**/ ?>