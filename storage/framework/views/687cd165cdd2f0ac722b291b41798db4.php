<?php $__env->startSection('title', 'Riwayat Transaksi & Kwitansi - SMK Muhammadiyah Sekampung'); ?>
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('siswa.tagihan')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-50 border border-blue-200 text-blue-700 text-xs font-bold hover:bg-blue-100 transition">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="py-4 px-4 sm:px-6 font-mono font-bold text-slate-900">
                                <?php echo e($trx->nomor_transaksi); ?>

                            </td>

                            <!-- Tanggal -->
                            <td class="py-4 px-4 sm:px-6 text-slate-500 whitespace-nowrap">
                                <?php echo e($trx->tanggal_transaksi->format('d M Y')); ?>

                                <span class="block text-[10px] text-slate-400"><?php echo e($trx->tanggal_transaksi->format('H:i')); ?> WIB</span>
                            </td>

                            <!-- Metode -->
                            <td class="py-4 px-4 sm:px-6">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider
                                    <?php echo e($trx->metode_pembayaran === 'tunai' ? 'bg-blue-50 text-blue-700 border border-blue-200' : 'bg-slate-100 text-slate-700 border border-slate-200'); ?>">
                                    <i class="fa-solid <?php echo e($trx->metode_pembayaran === 'tunai' ? 'fa-money-bill-wave' : 'fa-building-columns'); ?>"></i>
                            ...
                            <td class="py-4 px-4 sm:px-6">
                                <div class="space-y-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $trx->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center justify-between gap-2 text-[11px]">
                                            <span class="font-medium text-slate-800"><?php echo e($detail->posPembayaran?->nama_pos); ?></span>
                                            <span class="text-slate-500 font-semibold">Rp <?php echo e(number_format($detail->nominal_bayar, 0, ',', '.')); ?></span>
                                        </div>
                            ...
                            <td class="py-4 px-4 sm:px-6 text-right font-black text-slate-900 text-sm">
                                Rp <?php echo e(number_format($trx->nominal_pokok, 0, ',', '.')); ?>

                            </td>

                            <!-- Status Verifikasi & Bukti -->
                            <td class="py-4 px-4 sm:px-6 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trx->status === 'terverifikasi'): ?>
                                ...
                                <?php elseif($trx->status === 'menunggu_verifikasi'): ?>
                                ...
                                <?php elseif($trx->status === 'ditolak'): ?>
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[10px] font-extrabold bg-rose-100 text-rose-800" title="<?php echo e($trx->catatan_bendahara ?? 'Bukti tidak sesuai'); ?>">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trx->buktiPembayaran?->file_path): ?>
                                    <div class="mt-1 flex items-center justify-center gap-2">
                                        <a href="<?php echo e(asset('storage/' . $trx->buktiPembayaran->file_path)); ?>" target="_blank" 
                                        ...
                                        <a href="<?php echo e(route('bukti.download', $trx->buktiPembayaran->id)); ?>" 
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trx->catatan_bendahara): ?>
                                    <p class="text-[10px] text-rose-600 mt-1 italic max-w-xs"><?php echo e($trx->catatan_bendahara); ?></p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>

                            <!-- Tombol Kwitansi -->
                            <td class="py-4 px-4 sm:px-6 text-center">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($trx->status === 'terverifikasi' && $trx->kwitansi): ?>
                                    <a href="<?php echo e(route('kwitansi.pdf', $trx->kwitansi->id)); ?>" target="_blank"
...
<?php echo $__env->make('layouts.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\web skripsi\resources\views/siswa/riwayat.blade.php ENDPATH**/ ?>